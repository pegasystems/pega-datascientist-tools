...
params:
  ...
  predictordatafile:
    ...
    #value: "~/Downloads/Model_Report_2020-09-25_07-20-34.xlsx"
  modeldescription:
    ...
    #value: "OmniNBA - Credit Card Gold"
  modelid:
...
if (endsWith(params$predictordatafile, ".xlsx")) {
  ...
  setnames(modelPredictorBins, 
           ...
           new=c("pypredictorname", "pypredictortype", "pyperformance", "pybinindex", "pybinsymbol", "pybinnegatives", "pybinpositives", "pyentrytype", "pyzratio", "pylift"))
  modelPredictorBins[, pysnapshottime := cdhtools::toPRPCDateTime(now())]
  modelPredictorBins[, pymodelid := 0]
  for (num in c("pylift", "pyperformance", "pybinnegatives", "pybinpositives", "pybinindex", "pyzratio")) {
...
# for all: pyentrytype != "Classifier"
for (f in unique(modelPredictorBins[pyentrytype == "Active"]$pypredictorname)) {
