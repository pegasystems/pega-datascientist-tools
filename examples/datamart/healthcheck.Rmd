...
params:
  ...
  modelfile:
    ...
    # value: "/Users/perdo/.datamartcache/models_LMMS.parquet"
    value: "~/Downloads/Trimmed_Data-Decision-ADM-ModelSnapshot_pyModelSnapshots_20220527T095614_GMT.zip"
  ...
  predictordatafile:
    ...
    # value: "/Users/perdo/.datamartcache/preds_LMMS.parquet"
    value: "/Users/perdo/Library/CloudStorage/OneDrive-SharedLibraries-PegasystemsInc/AI Chapter Data Sets - Documents/Customers/LMMS/DataMart - 14th June 2022/Data-Decision-ADM-PredictorBinningSnapshot_pyADMPredictorSnapshots_20220614T134334_GMT.zip"
...
and predictors. It is generated from an R notebook in the [CDH Tools] 
(https://github.com/pegasystems/cdh-datascientist-tools). That repository
...
```{r}
responseRates <- datamart$modeldata[, SnapshotTimeDay := ceiling_date(SnapshotTime, unit="days")] [, .(ResponseCount = sum(ResponseCount)), by=c("SnapshotTimeDay", "Channel", "ConfigurationName")][order(SnapshotTimeDay)]
