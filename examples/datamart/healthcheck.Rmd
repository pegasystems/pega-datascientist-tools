...
| Average number of Groups per Issue | `r mean(datamart$modeldata[, .(Groups = uniqueN(Group)), by="Issue"]$Groups)` | `r paste(sort(unique(datamart$modeldata$Group)), collapse=", ")` |
| Number of unique Channels | `r uniqueN(datamart$modeldata$Channel)` | `r paste(sort(unique(datamart$modeldata$Channel)), collapse=", ")` |
