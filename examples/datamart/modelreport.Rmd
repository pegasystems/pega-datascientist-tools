...
subtitle: "For `r params$modeldescription`"
...
# TODO: swap y-axes and bars less prominent
...
plotADMPredictorImportance(modelPredictorBins[EntryType=="Active",ResponseCount:=Positives+Negatives], categoryAggregateView = T)
```
