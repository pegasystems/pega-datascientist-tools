...
print(unique(admdatamart$predictordata[TotalBins>4 & Type=="numeric" & EntryType == "Active"]$PredictorName))
```

```{r}
model <- filterLatestSnapshotOnly(admdatamart$modeldata) [Name == "AutoNew36Months" & Channel == "SMS"]
modelpredictors <- filterLatestSnapshotOnly(admdatamart$predictordata) [ModelID == model$ModelID & EntryType != "Inactive"]
