...
1. Create a design doc as `YYYY-MM-DD-<topic>-design.md`
2. If needed for active tracking, add/update the relevant `*-TODO.md` backlog
3. Do not keep dated implementation-only notes long term
