...
from pdstools.infinity.resources.prediction_studio.v24_2.champion_challenger import (
    ChampionChallenger,
)
from pdstools.infinity.resources.prediction_studio.v24_2.model import Model
from pdstools.infinity.resources.prediction_studio.v24_2.model_upload import (
    UploadedModel,
)
