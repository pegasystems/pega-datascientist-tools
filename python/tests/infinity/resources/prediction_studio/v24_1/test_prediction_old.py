...
def test_prediction_get_metric(prediction_client):
    ...
    with patch.object(prediction_client._client, 'get', return_value=mock_response) as mock_get:
        result = prediction_client.get_metric(metric="Performance",
                        timeframe="7d")
        
        mock_get.assert_called_once_with('/prweb/api/PredictionStudio/v1/predictions/CDHSAMPLE-DATA-CUSTOMER!PREDICTCUSTOMERACCEPTSCARDS/metric/Performance', time_frame='7d')
