...
class _SharedChampionChallengerMixin:
    """``ChampionChallenger`` business logic shared by ``v26_1`` and ``v27_1``.

    Concrete per-version mixins only need to set the ``_endpoints`` class
    attribute — see ``v26_1/champion_challenger/_mixin.py`` and
    ``v27_1/champion_challenger/_mixin.py``.
    """
