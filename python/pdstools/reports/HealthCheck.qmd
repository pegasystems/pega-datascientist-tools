...
Exporting and adding the Prediction Data will provide an overview of the data by channel and plots of the recent prediction lift and responses (select CDH Sample for an example).
:::

::: {.content-hidden unless-meta="analysis.predictions" .allow-math}
