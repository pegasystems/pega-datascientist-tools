...
formatted_channel_overview = (
    report_utils.create_metric_table(
        df_channel_overview,
        ...
        column_to_metric={
            ...
            "CTR": report_utils.percentage_within_0_1_range_rag,
        ...
        report_utils.create_metric_table(
            ...
            column_to_metric={
                ...
                (
                    ...
                    "CTR_Control",
                    "CTR_NBA",
                ): report_utils.percentage_within_0_1_range_rag,
                "Lift": "EngagementLift",
            },
        )
        .fmt_percent(
...
gt = (
    report_utils.create_metric_table(df_action_overview, title="Action Overview")
...
if "Issue" in datamart_all_columns and "Group" in datamart_all_columns:
    ...
    gt = report_utils.create_metric_table(
...
```{python}
# TODO: Use feature importance if available in the datamart
...
# TODO this one may be expensive if there's a lot of configurations
# yet cluttering them together makes no sense
...
if datamart.predictor_data is not None:
    bad_predictors = (
        ...
        .filter(pl.col("Mean") < MetricLimits.minimum("ModelPerformance"))
        .collect()
    )
...
maturity_criteria = {
    ...
    f"Models that have received sufficient responses but still have a low performance (AUC < {MetricLimits.minimum('ModelPerformance')})": (
        (pl.col("Performance") > 0.5)
        & (pl.col("Performance") < (MetricLimits.minimum("ModelPerformance") / 100))
        & (
            pl.col("Positives")
            >= MetricLimits.best_practice_min("TotalPositiveCount")
        )
