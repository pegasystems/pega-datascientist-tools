...
datafolder = "/Users/perdo/Library/CloudStorage/OneDrive-SharedLibraries-PegasystemsInc/AI Chapter Data Sets - Documents/Customers/British Telecom Consumer/HC"
...
try:
    ...
    traceback.print_exc()
    print(f"Error in All Success Rates Treemap plot: {e}")
...
try:
    ...
    traceback.print_exc()
    print(f"Error in Success Rates over Time plot: {e}")
```
...
try:
    ...
    traceback.print_exc()
    print(f"Error in Model Performance vs Action Success Rates plot: {e}")
...
try:
    ...
    traceback.print_exc()
    print(f"Error in Model Performance over Time plot: {e}")
...
if datamart.predictor_data is not None:
    for conf in datamart.unique_configurations:
        try:
            ...
            traceback.print_exc()
            print(f"Error in Predictor Performance across Actions plot for {conf}: {e}")
...
try:
    ...
    traceback.print_exc()
    print(f"Error in Propensity Distribution plot: {e}")
