...
formatted_channel_overview = (
    report_utils.table_standard_formatting(
        ...
        highlight_limits={
            ...
            "Responses": "Responses",
            "Actions": ["Actions", "Used Actions"],
            "Treatments": ["Treatments", "Used Treatments"],
            "Issues": "Issues",
...
```{python}
action_trend_data = datamart.aggregates.overall_summary(by_period="1w").collect()
...
display(
    report_utils.table_standard_formatting(
        ...
        highlight_lists={
            "Channel": cdh_guidelines.standard_channels,
            "Direction": cdh_guidelines.standard_directions,
            "Configuration": cdh_guidelines.standard_non_default_configurations,
        },
    )
    .tab_style(
