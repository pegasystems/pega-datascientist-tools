...
```{python}
predictors_per_configuration = datamart.predictors_per_configuration.to_pandas(use_pyarrow_extension_array=True)
...
bad_predictors = datamart.bad_predictors.to_pandas(use_pyarrow_extension_array=True)
