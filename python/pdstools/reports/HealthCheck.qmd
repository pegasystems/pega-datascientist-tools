...
from pdstools.utils import pega_template, report_utils
...
try:
    ...
    report_utils.quarto_plot_exception(f"Top {barchart_max_bars} Highest Responses", e)
...
try:
    ...
    report_utils.quarto_plot_exception(f"Top {barchart_max_bars} Highest Positives", e)
...
try:
    ...
    report_utils.quarto_plot_exception("Positives vs. Number of Models", e)
