...
def hide_metric_annotations_left_col(fig):
    ...
    subplots, using only axes that have actual traces to avoid phantom empty-slot axes.
    """
...
if datamart.has_single_snapshot:
    ...
    try:
        ...
        hide_metric_annotations_left_col(fig)
        fig.show()
    except ValueError as e:
        print(
