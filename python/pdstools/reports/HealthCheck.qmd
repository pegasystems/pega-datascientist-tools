...
threshold_active_models = 30 # if no responses in this nr of days assume not active

active_models_filter_expr = (
    (pl.col("SnapshotTime") - pl.col("LastUpdate")).dt.total_days() < threshold_active_models
).fill_null(True)
```
...
df_channel_overview = (
    ...
    datamart.aggregates.summary_by_channel(window=datetime.timedelta(days=30))
    .with_columns(
