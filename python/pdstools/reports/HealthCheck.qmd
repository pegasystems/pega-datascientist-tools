...
if len(kwargs) > 0:
    ...
    if "title" in kwargs and len(kwargs["title"]) > 0:
        title = kwargs["title"]
    if "subtitle" in kwargs and len(kwargs["subtitle"]) > 0:
...
try:
    ...
    quarto_plot_exception("All ADM Models", e)
```
...
try:
    ...
    quarto_plot_exception("Success Rates per Channel", e)
...
try:
    ...
    quarto_plot_exception("All Success Rates Treemap", e)
```
...
try:
    ...
    quarto_plot_exception("Success Rates over Time", e)
```
...
try:
    ...
    quarto_plot_exception("Model Performance vs Action Success Rates", e)
...
try:
    ...
    quarto_plot_exception("Model Performance over Time", e)
...
try:
    ...
    quarto_plot_exception("Overview of Model Performance", e)
...
try:
    ...
    quarto_plot_exception("Overview of Response Counts", e)
...
if datamart.predictor_data is not None:
    try:
        ...
        quarto_plot_exception("Predictor Importance across all models per configuration", e)
else:
    quarto_callout_no_predictor_data_warning()
```
...
if datamart.predictor_data is not None:
    ...
    try:
        ...
        quarto_plot_exception("Predictor Category performance per Channel", e)
else:
    quarto_callout_no_predictor_data_warning()
...
if datamart.predictor_data is not None:
    try:
        ...
        quarto_plot_exception("Relative Predictor Category importance", e)
else:
    quarto_callout_no_predictor_data_warning()
```
...
if datamart.predictor_data is not None:
    ...
    try:
        ...
        quarto_plot_exception("Number of Active and Inactive Predictors", e)
else:
    quarto_callout_no_predictor_data_warning()
```
...
if datamart.predictor_data is not None:
    for conf in datamart.unique_configurations:
        try:
            ...
            quarto_plot_exception("Predictor Performance across Actions", e)
...
if datamart.predictor_data is not None:
    ...
    try:
        ...
        quarto_plot_exception("Predictor Missing Data", e)
else:
    quarto_callout_no_predictor_data_warning()
...
try:
    ...
    quarto_plot_exception("Number of Empty/Immature Models over time", e)
```
...
try:
    ...
    quarto_plot_exception("Cumulative Responses", e)
...
try:
    ...
    quarto_plot_exception("Cumulative Positives", e)
```
...
try:
    ...
    quarto_plot_exception(f"Top {barchart_max_bars} Highest Responses", e)
...
try:
    ...
    quarto_plot_exception(f"Top {barchart_max_bars} Highest Positives", e)
...
try:
    ...
    quarto_plot_exception("Analysis of Performance vs Volume", e)
```
...
try:
    ...
    quarto_plot_exception("Positives vs. Number of Models", e)
...
try:
    ...
    quarto_plot_exception("Propensity Distribution", e)
