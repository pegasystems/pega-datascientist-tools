...
gt = (
    report_utils.create_metric_table(
        ...
        column_to_metric={
            ...
            "Base Propensity": report_utils.percentage_within_0_1_range_rag,
        },
    ).cols_label(
...
def show_single_predictor(pred):
    ...
    display(
        report_utils.create_metric_table(predictor_properties.collect())
        .fmt_number(
            decimals=2,
            scale_by=100.0,
            columns=["Univariate Performance"],
    ...
    display(
        report_utils.create_metric_table(human_friendly_binning_table)
