...
try:
    ...
    traceback.print_exc()
    print(f"Error in Score Distribution plot: {e}")
...
try:
    ...
    traceback.print_exc()
    print(f"Error in Cumulative Gains plot: {e}")
...
try:
    ...
    traceback.print_exc()
    print(f"Error in Class Separation plot: {e}")
...
try:
    ...
    traceback.print_exc()
    print(f"Error in Model Performance Trend plot: {e}")
...
try:
    ...
    traceback.print_exc()
    print(f"Error in Success Rate Trend plot: {e}")
```
...
try:
    ...
    traceback.print_exc()
    print(f"Error in Predictor Performance per Category plot: {e}")
...
def show_single_predictor(pred):
    ...
    try:
        ...
        traceback.print_exc()
        print(f"Error in Predictor Binning plot for {pred}: {e}")
