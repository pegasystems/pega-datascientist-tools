...
if len(kwargs) > 0:
    ...
    datamart = ADMDatamart(
        model_df=model_df, predictor_df=predictor_df, query=pl.col("ModelID") == model_id
    )#.fillMissing()
...
# unfortunately, return_df on the previous plot doesnt give all the columns we'd need
