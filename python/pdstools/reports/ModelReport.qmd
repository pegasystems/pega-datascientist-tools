...
try:
    ...
    quarto_plot_exception("Classifier Score Distribution", e)
...
try:
    ...
    quarto_plot_exception("Cumulative Gains", e)
...
try:
    ...
    quarto_plot_exception("Class Separation", e)
...
try:
    ...
    quarto_plot_exception("Model Performance Trend", e)
...
try:
    ...
    quarto_plot_exception("Success Rate Trend", e)
```
...
try:
    ...
    quarto_plot_exception("Predictor Performance per Category", e)
...
def show_single_predictor(pred):
    ...
    try:
        ...
        quarto_plot_exception(f"Error in Predictor Binning plot for {pred}", e)
