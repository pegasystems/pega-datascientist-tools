    ...
    def _read_params(self):
        ...
        if not os.path.exists(params_file):
            ...
            with open(params_file, "r", encoding=ENCODING) as file:
                ...
                self.sort_by = params.get(
                    "sort_by", SORT_BY_DEFAULT
                )
                self.sort_by_text = params.get(
                    "sort_by_text", SORT_BY_TEXT_DEFAULT
                )
                self.display_by = params.get(
                    "display_by", DISPLAY_BY_DEFAULT
                )
                self.display_by_text = params.get(
                    "display_by_text", DISPLAY_BY_TEXT_DEFAULT
                )
