...
fig = datamart.plotTreeMap(color_var="SuccessRate",
                     groupby_col= None,
                     tree_levels=['Channel', 'Direction', 'Issue', 'Group', "Name"], 
...
```{python}
fig = datamart.plotTreeMap(color_var="performance_weighted", groupby_col= None, tree_levels=['Channel', 'Direction', 'Issue', 'Group', "Name"], color_scale=color_scale["performance"])
...
fig = datamart.plotTreeMap(color_var="responsecount", tree_levels=['Channel', 'Direction', 'Issue', 'Group', "Name"], colorscale=color_scale["bad_to_good"])
fig
...
unique_count = datamart.modelData.select(facets).collect().unique().shape[0]
height = 200 + (math.ceil( unique_count / 2) * 250)
